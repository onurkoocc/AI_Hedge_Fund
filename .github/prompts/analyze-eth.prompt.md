...
name: analyze-eth
mode: agent
description: "ETH/USDT tekil analiz ve pozisyon önerisi"
tools: ["run_in_terminal", "read_file", "semantic_search"]
---

# ETH/USDT Piyasa Analizi ve Pozisyon Önerisi

## Görev

1. **Market Scanner'ı çalıştır** (sadece ETH/USDT için):
```bash
python tools/market_scanner.py --symbols ETH/USDT --days 180
```
